# CLAUDE.md — Digital Resilience Assessment (DRA)
# This file is read by AI coding assistants (opencode, Claude Code, etc.)
# to understand the project before making changes.
